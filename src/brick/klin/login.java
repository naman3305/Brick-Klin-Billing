    ...
    login()
{
    ...
    ImageIcon ic1=new ImageIcon("C:\\Users\\hp\\Documents\\NetBeansProjects\\Brick Klin\\src\\icons\\pop.png");
    Image ig1=ic1.getImage().getScaledInstance(128, 128,Image.SCALE_DEFAULT);
    ImageIcon i1=new ImageIcon(ig1);
    l3=new JLabel(i1);
    
    ImageIcon ic2=new ImageIcon("C:\\Users\\hp\\Documents\\NetBeansProjects\\Brick Klin\\src\\icons\\login.png");
    Image ig2=ic2.getImage().getScaledInstance(16,16,Image.SCALE_DEFAULT);
    b1=new JButton("Login",new ImageIcon(ig2));
    
    ImageIcon ic3=new ImageIcon("C:\\Users\\hp\\Documents\\NetBeansProjects\\Brick Klin\\src\\icons\\cancel.jpg");
    Image ig3=ic3.getImage().getScaledInstance(16,16,Image.SCALE_DEFAULT);
    b2=new JButton("Login",new ImageIcon(ig3));
